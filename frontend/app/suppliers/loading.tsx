export default function Loading() {
  return (
    <div className="p-8 animate-pulse">
      ...
      <div className="h-4 w-72 bg-secondary rounded mb-6" />
      <div className="flex gap-4 mb-6">
        <div className="h-10 w-28 bg-card border border-border rounded" />
        <div className="h-10 w-36 bg-card border border-border rounded" />
      </div>
